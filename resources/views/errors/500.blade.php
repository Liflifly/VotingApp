...
<head>
    ...
    <title>500 - Kegagalan Inti Sistem</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        ...
        <div class="max-w-xl w-full">
            <div class="bg-white border-4 border-black p-8 md:p-12 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden group">
                <!-- Decorative Corner -->
                <div class="absolute top-0 left-0 w-16 h-16 bg-[#FF3C3C] border-r-4 border-b-4 border-black transition-transform group-hover:-translate-x-1 group-hover:-translate-y-1"></div>
                
                <!-- Error Code -->
                <div class="font-black text-[120px] leading-none text-black/5 absolute -bottom-4 -right-4 select-none italic">500</div>

                <div class="relative z-10">
                    <div class="inline-block bg-[#000000] text-white border-4 border-black px-4 py-1 font-black text-xl mb-8 transform rotate-1">
                        ERROR_CODE: 500
                    </div>

                    <h1 class="text-4xl md:text-5xl font-black text-black leading-none mb-6 uppercase tracking-tighter">
                        KRITICAL: <br><span class="text-[#ef4444]">MELTDOWN</span> SISTEM.
                    </h1>

                    <p class="text-lg font-bold text-black/60 mb-10 max-w-md leading-relaxed">
                        Inti server kami sedang mengalami panas berlebih. <br>
                        Teknisi kami sedang mencoba mendinginkannya dengan kopi dan barisan kode.
                    </p>

                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center px-8 py-4 bg-[#ef4444] text-white border-4 border-black font-black text-lg uppercase tracking-tight shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] active:translate-x-[6px] active:translate-y-[6px] transition-all">
                            REBOOT KE DASHBOARD
                        </a>
                    </div>
                </div>
